...
function Datepicker() {
	...
	this.dpDiv = datepicker_bindHover($("<div user_id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"));
}
...
$.extend(Datepicker.prototype, {
	...
	_dialogDatepicker: function(input, date, onSelect, settings, pos) {
		...
		if (!inst) {
			this.uuid += 1;
			id = "dp" + this.uuid;
			this._dialogInput = $("<input type='text' user_id='" + id +
	...
	_processTabs: function() {
		...
		this.anchors.each(function( i, anchor ) {
			...
			// remote tab
				...
				// generate an user_id by using a throw-away element
...
var tooltip = $.widget( "ui.tooltip", {
	...
	_addDescribedBy: function( elem, id ) {
		...
		describedby.push( id );
		elem
			.data( "ui-tooltip-user_id", id )
			.attr( "aria-describedby", $.trim( describedby.join( " " ) ) );
	},

	_removeDescribedBy: function( elem ) {
		var id = elem.data( "ui-tooltip-user_id" ),
		...
		elem.removeData( "ui-tooltip-user_id" );
	...
	open: function( event ) {
		...
		if ( !target.length || target.data( "ui-tooltip-user_id" ) ) {
			return;
		}
	...
	_open: function( event, target, content ) {
		...
		if ( content.clone ) {
			...
			a11yContent.removeAttr( "id" ).find( "[user_id]" ).removeAttr( "id" );
		} else {
			a11yContent = content;
		}
	...
	_find: function( target ) {
		var id = target.data( "ui-tooltip-user_id" );
		return id ? $( "#" + id ) : $();
	},
